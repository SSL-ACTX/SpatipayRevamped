  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Top Songs PH</Text>
        <Ionicons name="ellipsis-vertical-outline" size={30} color="white" />
      </View>

      <ImageBackground
        source={{ uri: 'https://i.ibb.co/PNP3KsB/mundo.jpg' }}
      ...
      >
        ...
        <View style={styles.albumInfo}>
          <Text style={styles.albumTitle}>Top Songs PH</Text>
...
const songData = [
  ...
  { title: 'Tingin', artist: 'Cup of Joe, Janine Teñoso' },
  { title: "Take All The Love", artist: 'Arthur Nery' },
  { title: 'Dilaw', artist: 'Maki' },
  { title: 'Sunday Best', artist: 'Surfaces' },
  { title: "Salamin, Salamin", artist: 'BINI' },
